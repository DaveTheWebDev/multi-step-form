...
export const Checkmark = ({ dephLevel }: { dephLevel: number }) => {
  return <S.Checkmark dephLevel={dephLevel} width="12" height="10" viewBox="0 0 12 10" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden='true' focusable='false'>
