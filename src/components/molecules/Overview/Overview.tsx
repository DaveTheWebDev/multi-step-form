...
export const Overview = ({ privilegeCheckboxesState, privileges, setStepNumber, selectedCompanyId, selectedCompanyName }: OverviewProps) => {
  ...
  return (
    <Step>
      ...
      <InfoSection title={chosenPrivileges}>
        <ChosenPrivileges privileges={privileges} privilegeCheckboxesState={privilegeCheckboxesState} emptyPrivilegesLabel={emptyPrivileges} />
      </InfoSection>
